  ...
  return (
    <Box px={6} py={{ base: 16, md: 24 }} maxW="3xl" mx="auto">
      ...
      <UnorderedList mb={6} pl={6}>
        ...
        <ListItem>Payment and billing information (limited to what is shared by our payment processor)</ListItem>
      ...
      <UnorderedList mb={6} pl={6}>
        <ListItem>Service providers who help us deliver services (e.g., Stripe for payment processing)</ListItem>
      ...
      <Text mb={6}>
        If we transfer your personal data overseas (for example, when using third-party tools like Stripe or analytics services), we ensure it is protected by appropriate safeguards consistent with this Privacy Policy.
      </Text>
